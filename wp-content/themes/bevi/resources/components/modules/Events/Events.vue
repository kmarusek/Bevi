    ...
    <div class="relative flex flex-col overflow-hidden">
      <div class="grid grid-cols-5 gap-4 mt-24 h-header">
        <div class="col-span-5 md:col-span-2 relative h-full flex items-align-center">
          <h1 v-bind:style="{ 'background-image': 'url(/wp-content/themes/bevi/dist/images/eventblob.png)' }" class="heading-two text-center w-72 h-64 bg-cover m-auto align-middle eventblobtext">{{ block.main_title }}</h1>
        </div>
