...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_script('sage/manifest.js', asset_path('scripts/manifest.js'), '', filemtime(get_theme_root() . '/bevi/dist/scripts/manifest.js'), true);
    wp_enqueue_script('sage/vendor.js', asset_path('scripts/vendor.js'), '', filemtime(get_theme_root() . '/bevi/dist/scripts/vendor.js'), true);
