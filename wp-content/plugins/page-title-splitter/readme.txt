...
1. Setting breakpoints in the title of the page.
2. Removing a breakpoint that is located in the text field.
3. The page title with the breaks in place.
4. Settings page and instructions on how to use below.
...
Thank you to giomorin for letting me know about the issues
= 2.0.8 =
* Fixed issue with the showing of code on the single product page, this replaces the WooCommerce single product page title template if a custom one is not being used
Thank you to giomorin for letting me know about the issue
= 2.0.9 =
* Fixed issue with the page splitter box not showing on the post and page admin pages
Thank you to neotechnomad for letting me know about the issue
= 2.5.0 =
