...
if ( version_compare( phpversion(), '5.3', '>=' ) ) {
	...
	define( 'MDD_PRO_PATH', plugin_dir_path( MDD_PRO_FILE ) );
	define( 'MDD_PRO_INCLUDES_DIR', MDD_PRO_PATH . '/inc/' );
	require_once MDD_PRO_INCLUDES_DIR . 'class-media-deduper-pro.php';

	// Load the Action Scheduler library.
	require_once MDD_PRO_PATH . '/vendor/action-scheduler/action-scheduler.php';
