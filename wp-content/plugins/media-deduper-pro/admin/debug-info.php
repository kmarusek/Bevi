...
<code id="debug-code" style="margin:1rem 0;padding:1rem;display:block;white-space:pre-wrap;"><?php esc_html_e( 'WP Info', 'media-deduper' ); ?>
	...
	<?php esc_html_e( 'Basic Auth Enabled', 'media-deduper' ); ?>:
	<?php mdd_basic_auth_check_output(); ?>
	
	<?php esc_html_e( 'Action Scheduler Test', 'media-deduper' ); ?>: 
	<?php mdd_as_test_output(); ?>
...
<?php esc_html_e( 'Media Deduper Info', 'media-deduper' ); ?>
	...
	<?php esc_html_e( 'Version', 'media-deduper' ); ?>: <?php echo esc_html( $media_deduper_pro::VERSION ); ?>
</code>
