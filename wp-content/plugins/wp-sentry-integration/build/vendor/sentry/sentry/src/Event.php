...
final class Event
{
     ...
     */
    public static function createEvent(?\Sentry\EventId $eventId = null) : self
    {
        return new self($eventId, \Sentry\EventType::event());
    }
    /**
     ...
     */
    public function getId() : \Sentry\EventId
    {
        return $this->id;
    }
    /**
     ...
     */
    public function getLevel() : ?\Sentry\Severity
    {
        return $this->level;
    }
    /**
     ...
     */
    public function setLevel(?\Sentry\Severity $level) : void
    {
        $this->level = $level;
    }
    /**
     ...
     */
    public function setUser(?\Sentry\UserDataBag $user) : void
    {
        $this->user = $user;
    }
    /**
     ...
     */
    public function getOsContext() : ?\Sentry\Context\OsContext
    {
     ...
     */
    public function setOsContext(?\Sentry\Context\OsContext $osContext) : void
    {
     ...
     */
    public function getRuntimeContext() : ?\Sentry\Context\RuntimeContext
    {
     ...
     */
    public function setRuntimeContext(?\Sentry\Context\RuntimeContext $runtimeContext) : void
    {
    ...
    public function setExceptions(array $exceptions) : void
    {
        foreach ($exceptions as $exception) {
            if (!$exception instanceof \Sentry\ExceptionDataBag) {
                throw new \UnexpectedValueException(\sprintf('Expected an instance of the "%s" class. Got: "%s".', \Sentry\ExceptionDataBag::class, \get_debug_type($exception)));
            }
        }
     ...
     */
    public function getStacktrace() : ?\Sentry\Stacktrace
    {
     ...
     */
    public function setStacktrace(?\Sentry\Stacktrace $stacktrace) : void
    {
