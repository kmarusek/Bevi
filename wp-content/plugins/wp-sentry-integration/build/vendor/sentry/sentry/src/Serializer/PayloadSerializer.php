...
final class PayloadSerializer implements \Sentry\Serializer\PayloadSerializerInterface
{
     ...
     */
    public function toArray(\Sentry\Event $event) : array
    {
     ...
     * }
     */
    private function serializeBreadcrumb(\Sentry\Breadcrumb $breadcrumb) : array
    {
     ...
     * }
     */
    private function serializeException(\Sentry\ExceptionDataBag $exception) : array
    {
     ...
     * }
     */
    private function serializeStacktraceFrame(\Sentry\Frame $frame) : array
    {
     ...
     * }
     */
    private function serializeSpan(\Sentry\Tracing\Span $span) : array
    {
