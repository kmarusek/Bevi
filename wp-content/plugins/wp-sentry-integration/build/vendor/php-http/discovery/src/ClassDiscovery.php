...
use WPSentry\ScopedVendor\Http\Discovery\Exception\ClassInstantiationFailedException;
...
abstract class ClassDiscovery
{
    ...
    protected static function findOneByType($type)
    {
        ...
        foreach (self::$strategies as $strategy) {
            ...
            $exceptions[] = new \WPSentry\ScopedVendor\Http\Discovery\Exception\NoCandidateFoundException($strategy, $candidates);
        }
        throw \WPSentry\ScopedVendor\Http\Discovery\Exception\DiscoveryFailedException::create($exceptions);
    }
    /**
    ...
    protected static function instantiateClass($class)
    {
        try {
            ...
            throw new \WPSentry\ScopedVendor\Http\Discovery\Exception\ClassInstantiationFailedException('Unexpected exception when instantiating class.', 0, $e);
        }
