...
namespace WPSentry\ScopedVendor\Http\Message\Stream;
 ...
 */
class BufferedStream implements \WPSentry\ScopedVendor\Psr\Http\Message\StreamInterface
{
     ...
     *                                       the data in a file
     */
    public function __construct(\WPSentry\ScopedVendor\Psr\Http\Message\StreamInterface $stream, $useFileBuffer = \true, $memoryBuffer = 2097152)
    {
        $this->stream = $stream;
