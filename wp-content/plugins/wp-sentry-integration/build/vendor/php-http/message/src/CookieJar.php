...
final class CookieJar implements \Countable, \IteratorAggregate
{
     ...
     * @return bool
     */
    public function hasCookie(\WPSentry\ScopedVendor\Http\Message\Cookie $cookie)
    {
     ...
     * Adds a cookie.
     */
    public function addCookie(\WPSentry\ScopedVendor\Http\Message\Cookie $cookie)
    {
     ...
     * Removes a cookie.
     */
    public function removeCookie(\WPSentry\ScopedVendor\Http\Message\Cookie $cookie)
    {
     ...
     * @return Cookie[]
     */
    public function getMatchingCookies(\WPSentry\ScopedVendor\Http\Message\Cookie $cookie)
    {
