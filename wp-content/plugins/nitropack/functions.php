    ...
    try {
        ...
        if (null !== $nitro = get_nitropack_sdk($siteId, $siteSecret, NULL, true)) {
            if (!$nitro->checkHealthStatus()) {
                nitropack_json_and_exit(array(
                    "status" => "error",
                    "message" => __( 'Error when trying to communicate with NitroPack\'s servers. Please try again in a few minutes. If the issue persists, please', 'nitropack' )." <a href='https://support.nitropack.io/hc/en-us' target='_blank'>contact us</a>."
                ));
            }
...
function nitropack_enable_safemode() {
    if (null !== $nitro = get_nitropack_sdk()) {
        ...
        nitropack_json_and_exit(array(
            "type" => "success",
            "message" => __( 'Success! Safe mode has been enabled successfully!', 'nitropack' )
        ));
    }
...
function nitropack_disable_safemode() {
    if (null !== $nitro = get_nitropack_sdk()) {
        ...
        nitropack_json_and_exit(array(
            "type" => "success",
            "message" => __( 'Success! Safe mode has been disabled successfully!', 'nitropack' )
        ));
    }
