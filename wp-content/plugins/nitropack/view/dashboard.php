        ...
        <div class="card card-d-item">
          <div class="card-body">
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item px-0 d-flex justify-content-between align-items-center">
                <span><?php esc_html_e( 'Safe Mode', 'nitropack' ); ?></br>
                ...
                <span id="loading-safemode-status">
                  <?php esc_html_e( 'Loading safe mode status', 'nitropack' ); ?> <i class="fa fa-refresh fa-spin" style="color: var(--blue);"></i>
                </span>
              ...
              <?php if (nitropack_render_woocommerce_cart_cache_option()) { ?>
                <li class="list-group-item px-0 d-flex justify-content-between align-items-center">
                  <span><?php esc_html_e( 'Ecommerce Cart Cache', 'nitropack' ); ?> <span class="badge badge-info"><?php echo nitropack_is_cart_cache_available() ? __( 'New', 'nitropack' ) : '<a href="https://nitropack.io/pricing" target="_blank" rel="noopener noreferrer" class="text-white">'.__( 'Requires a paid subscription', 'nitropack' ).'</a>'; ?></span></br>
            ...
            <p class="mb-0 mt-2"><i class="fa fa-info-circle text-primary" aria-hidden="true"></i> <?php esc_html_e( 'You can further configure how NitroPack\'s optimization behaves through your account at', 'nitropack' ); ?> <a href="https://nitropack.io/" target="_blank">https://nitropack.io/&nbsp;&nbsp;<i class="fa fa-external-link"></i></a>.</p>
          </div>
        </div>
      </div>
    </div>
